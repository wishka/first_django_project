...
SECRET_KEY = getenv("DJANGO_SECRET_KEY", 'django-insecure-j3st_$hf6s(^v##ef-y88ve5%$#ht4q*@l^_&t$ure*9*7l#oz')
...
CACHES = {
    "default": {
        # Сделаем мнимый кэш, чтобы не выполнять реальное кэширование, которое может быть не полезно
